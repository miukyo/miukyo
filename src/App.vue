  ...
  <main class="max-w-[1920px] mx-auto relative">
    ...
    <Transition @leave="animOut">
      <div v-if="intro.open"
        ...
        <div class="top-10 absolute lg:w-1/3">
          <p class="text-center leading-2 mt-3 font-semibold tracking-tighter">!!!THIS WEBSITE IS STILL ON
            DEVELOPMENT!!!
          </p>
        </div>
    ...
    <div v-if="!intro.open" class="relative lg:m-5 rounded-2xl">
      ...
      <div class="main relative overflow-y-auto rounded-2xl">
        ...
        <!-- ?Bottom Deco  -->
        <div
          class="absolute bottom-7 left-14 z-[60] -mb-1 hidden lg:flex gap-5 text-xs font-bold uppercase tracking-tighter">
        ...
        <div class="hidden lg:block absolute bottom-7 right-14 z-[60]">
