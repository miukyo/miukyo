    ...
    <div class="flex flex-col mt-5">
      <div v-for="(e, i) in workLists.val" :key="i" class="flex flex-col lg:mb-16 mb-5">
        ...
        <div class="flex gap-5 lg:gap-20 mt-3 lg:mt-5">
          <p
            class="text-xs lg:text-base text-neutral-500 font-medium tracking-tighter leading-none">
            {{ e.createdAt }}
          </p>
          <div class="flex flex-col">
            ...
            <h1 class="text-2xl lg:text-5xl font-bold tracking-tight font-con lg:leading-none">
              {{ e.title }}
            </h1>
          </div>
        </div>
      ...
      <h1
        class="text-lg lg:text-2xl font-bold tracking-tight font-con lg:leading-none text-center pb-10 lg:pb-20">
        See more works at
        <a
          target="_blank"
          href="https://drive.google.com/drive/folders/1am9MynmYysocyPBcQ_TxChs_JP7EEVeG?usp=drive_link"
          class="w-fit transition-colors text-neutral-500 hover:text-black">
          here
        </a>
      </h1>
    </div>
